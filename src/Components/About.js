...
function About() {
  return (
    ...
    <p>
      ...
      voluptatibus facere aut illo omnis commodi quia corrupti dolor
      laudantium eum rerum iure, repellendus cupiditate ut, quasi voluptatem
      consequuntur quo similique.
    </p>
    <hr />
    <Row>
      <Col md={5}>
